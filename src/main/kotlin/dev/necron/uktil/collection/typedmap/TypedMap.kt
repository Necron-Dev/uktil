...
package dev.necron.uktil.collection.typedmap

import dev.necron.uktil.extension.type.ifTake
import dev.necron.uktil.functional.Transformer
...
inline fun TypedMap.mapValues(transformer: Transformer) = HashTypedMap(
    entries.map { (a, b) ->
