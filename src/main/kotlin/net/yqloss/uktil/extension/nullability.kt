...
inline infix fun <T1, T2> T1.notSameNotNull(other: T2): Boolean {
    contract {
        returns(true) implies (this@notSameNotNull === null || other === null)
        returns(false) implies (this@notSameNotNull !== null && other !== null)
    }

    return this === null || this !== other
}

inline infix fun <T1, T2> T1.equalsNotNull(other: T2): Boolean {
    contract {
        returns(true) implies (this@equalsNotNull !== null && other !== null)
        returns(false) implies (this@equalsNotNull === null || other === null)
    }

    return this !== null && this == other
}

inline infix fun <T1, T2> T1.notEqualsNotNull(other: T2): Boolean {
    contract {
        returns(true) implies (this@notEqualsNotNull === null || other === null)
        returns(false) implies (this@notEqualsNotNull !== null && other !== null)
    }
